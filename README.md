...
<body>
    ...
    <script>
       ...
       <h2 data-aos="zoom-in">Software & Tools Known</h2>

<div class="button-container">
  <button onclick="toggleInfo('accounting')">📊 Accounting Software</button>
...
<div id="accounting" class="info-box">
  <h3>Accounting & Finance Tools</h3>
  <ul>
    <li>Tally ERP / Tally Prime</li>
    <li>Zoho Books (Basic)</li>
    <li>GST Portal</li>
...
<div id="tech" class="info-box">
  <h3>Tech & Digital Platforms</h3>
  <ul>
    <li>GitHub (Portfolio Hosting)</li>
    <li>GitHub Pages</li>
    <li>Basic HTML, CSS & JavaScript</li>
    <li>Automation using Google Forms</li>
  </ul>
</div>
